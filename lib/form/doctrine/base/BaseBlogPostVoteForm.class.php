...
/**
 * BlogPostVote form base class.
 *
 * @method BlogPostVote getObject() Returns the current form's model object
 *
 * @package    blog
 * @subpackage form
 ...
 */
abstract class BaseBlogPostVoteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('blog_post_vote[%s]');
